...
var G__25653 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__25653,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__25653;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq25655){
...
var file = cljs.core.get.call(null,map__25662__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25662__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25662__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__25662,map__25662__$1,file,line,column){
return (function (p1__25661_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__25661_SHARP_));
});})(map__25662,map__25662__$1,file,line,column))
...
var temp__5457__auto___25664 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___25664)){
var message_25665 = temp__5457__auto___25664;
cljs.core.println.call(null,message_25665);
} else {
}
...
var temp__5457__auto___25666 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___25666)){
var message_25667 = temp__5457__auto___25666;
cljs.core.println.call(null,message_25667);
} else {
}
...
var output_dir__$1 = (function (){var G__25668 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__25668,"/"].join('');
} else {
return G__25668;
}
})();
...
var G__25670 = exception.stack;
var G__25670__$1 = (((G__25670 == null))?null:clojure.string.split_lines.call(null,G__25670));
var G__25670__$2 = (((G__25670__$1 == null))?null:cljs.core.get.call(null,G__25670__$1,depth));
if((G__25670__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__25670__$2);
}
} else {
...
var vec__25671 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__25671,(0),null);
var column = cljs.core.nth.call(null,vec__25671,(1),null);
var vec__25674 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__25674,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__25674,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__25674,(2),null);
...
var m__$1 = (function (){var G__25677 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__25677__$1 = (((G__25677 instanceof cljs.core.Keyword))?G__25677.fqn:null);
switch (G__25677__$1) {
case "fail":
...
var G__25681 = (function (){var G__25680 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__25680);
} else {
return G__25680;
}
})();
...
return cljs.core.vary_meta.call(null,G__25682,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__25686 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__25686,(0),null);
var types = vec__25686;
...
return cljs.core.map.call(null,(function (p__25689){
var vec__25690 = p__25689;
var ns = cljs.core.nth.call(null,vec__25690,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__25690,(1),null);
return ((function (vec__25690,ns,vars__$1){
return (function (){
...
var G__25693 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__25693__$1 = (((G__25693 instanceof cljs.core.Keyword))?G__25693.fqn:null);
switch (G__25693__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1){
return (function (){
var seq__25694 = cljs.core.seq.call(null,vars__$1);
var chunk__25695 = null;
var count__25696 = (0);
var i__25697 = (0);
while(true){
if((i__25697 < count__25696)){
var v = cljs.core._nth.call(null,chunk__25695,i__25697);
var temp__5457__auto___25699 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___25699)){
var t_25700 = temp__5457__auto___25699;
each_fixture_fn.call(null,((function (seq__25694,chunk__25695,count__25696,i__25697,t_25700,temp__5457__auto___25699,v,each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25700)));
});})(seq__25694,chunk__25695,count__25696,i__25697,t_25700,temp__5457__auto___25699,v,each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1))
);
} else {
}


var G__25701 = seq__25694;
var G__25702 = chunk__25695;
var G__25703 = count__25696;
var G__25704 = (i__25697 + (1));
seq__25694 = G__25701;
chunk__25695 = G__25702;
count__25696 = G__25703;
i__25697 = G__25704;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__25694);
if(temp__5457__auto__){
var seq__25694__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__25694__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__25694__$1);
var G__25705 = cljs.core.chunk_rest.call(null,seq__25694__$1);
var G__25706 = c__4550__auto__;
var G__25707 = cljs.core.count.call(null,c__4550__auto__);
var G__25708 = (0);
seq__25694 = G__25705;
chunk__25695 = G__25706;
count__25696 = G__25707;
i__25697 = G__25708;
continue;
} else {
var v = cljs.core.first.call(null,seq__25694__$1);
var temp__5457__auto___25709__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___25709__$1)){
var t_25710 = temp__5457__auto___25709__$1;
each_fixture_fn.call(null,((function (seq__25694,chunk__25695,count__25696,i__25697,t_25710,temp__5457__auto___25709__$1,v,seq__25694__$1,temp__5457__auto__,each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25710)));
});})(seq__25694,chunk__25695,count__25696,i__25697,t_25710,temp__5457__auto___25709__$1,v,seq__25694__$1,temp__5457__auto__,each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1))
);
} else {
}


var G__25711 = cljs.core.next.call(null,seq__25694__$1);
var G__25712 = null;
var G__25713 = (0);
var G__25714 = (0);
seq__25694 = G__25711;
chunk__25695 = G__25712;
count__25696 = G__25713;
i__25697 = G__25714;
continue;
}
} else {
...
});})(each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1))
);
});})(each_fixture_fn,G__25693,G__25693__$1,env,once_fixtures,each_fixtures,vec__25690,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25693__$1)].join('')));

}
})());
});
;})(vec__25690,ns,vars__$1))
