...
var G__27022 = devtools.prefs.pref.call(null,v);
v = G__27022;
continue;
} else {
return v;
...
}catch (e27025){var _e__26036__auto__ = e27025;
return false;
}})();
...
}catch (e27029){var _e__26036__auto__ = e27029;
return false;
}})();
...
}catch (e27031){var _e__26036__auto__ = e27031;
return false;
}}
}
});
...
var vec__27033 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27033,(0),null);
var name = cljs.core.nth.call(null,vec__27033,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27036_SHARP_);
}),template);
});
