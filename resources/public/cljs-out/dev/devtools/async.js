...
var o__26029__auto___28091 = (function (){var o__26029__auto__ = (function (){var o__26029__auto__ = Promise;
return (o__26029__auto__["resolve"]).call(o__26029__auto__);
})();
return (o__26029__auto__["then"]).call(o__26029__auto__,callback);
})();
(o__26029__auto___28091["catch"]).call(o__26029__auto___28091,devtools.async.rethrow_outside_promise);
...
var G__28092_28093 = Error;
var target__26034__auto___28094 = G__28092_28093;
if(cljs.core.truth_(target__26034__auto___28094)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28092_28093)].join(''),"\n","target__26034__auto__"].join('')));
}

(target__26034__auto___28094["stackTraceLimit"] = Infinity);
