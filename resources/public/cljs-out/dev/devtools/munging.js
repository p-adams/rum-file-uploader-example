...
var o26917 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26917["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26918 = temp__5455__auto____$1;
return (o26918["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26029__auto__ = f;
return (o__26029__auto__["toString"]).call(o__26029__auto__);
} else {
return "";
}
...
try{var o__26029__auto___26921 = t;
(o__26029__auto___26921["cljs$lang$ctorPrWriter"]).call(o__26029__auto___26921,t,writer);
}catch (e26920){var __26922 = e26920;
}
...
var char_code = (function (){var o__26029__auto__ = (new String(char$));
return (o__26029__auto__["charCodeAt"]).call(o__26029__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26029__auto__ = String;
return (o__26029__auto__["fromCharCode"]).call(o__26029__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26923 = num_code;
switch (G__26923) {
case (1):
return (185);
...
var o__26029__auto__ = String;
return (o__26029__auto__["fromCharCode"]).call(o__26029__auto__,superscript_code);
});
/**
...
}catch (e26925){var _e__26036__auto__ = e26925;
return false;
}})())){
...
var vec__26926 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26926,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o26929 = temp__5455__auto__;
var temp__5455__auto____$1 = (o26929["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o26930 = temp__5455__auto____$1;
return (o26930["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___26937 = arguments.length;
var i__4731__auto___26938 = (0);
while(true){
if((i__4731__auto___26938 < len__4730__auto___26937)){
args__4736__auto__.push((arguments[i__4731__auto___26938]));

var G__26939 = (i__4731__auto___26938 + (1));
i__4731__auto___26938 = G__26939;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26933){
var vec__26934 = p__26933;
var ns_detector = cljs.core.nth.call(null,vec__26934,(0),null);
...
var G__26940 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26941 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26940;
remaining_tokens = G__26941;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26931){
var G__26932 = cljs.core.first.call(null,seq26931);
var seq26931__$1 = cljs.core.next.call(null,seq26931);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26932,seq26931__$1);
});
...
var vec__26945 = cljs.core.split_with.call(null,(function (p1__26944_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26944_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26945,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26945,(1),null);
...
var vec__26951 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26951,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26951,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26954 = cljs.core.rest.call(null,remaining_tokens);
var G__26955 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26954;
name_tokens = G__26955;
continue;
} else {
...
var vec__26958 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26958,(0),null);
var arity = cljs.core.nth.call(null,vec__26958,(1),null);
var vec__26961 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26961,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26961,(1),null);
var vec__26964 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26964,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26964,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26964,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26964,(3),null);
...
var vec__26970 = result;
var munged_ns = cljs.core.nth.call(null,vec__26970,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26970,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26970,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26970,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26970,(4),null);
var arity = cljs.core.nth.call(null,vec__26970,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__26974 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__26974,(0),null);
var args = cljs.core.nth.call(null,vec__26974,(1),null);
var vec__26977 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26977,(0),null);
var name = cljs.core.nth.call(null,vec__26977,(1),null);
...
var G__26980 = (arity + (1));
var G__26981 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26982){
var vec__26983 = p__26982;
var arity = cljs.core.nth.call(null,vec__26983,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26983,(1),null);
...
return cljs.core.get.call(null,arities,p1__26986_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26987_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26990){
var vec__26991 = p__26990;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26991,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26988){
var G__26989 = cljs.core.first.call(null,seq26988);
var seq26988__$1 = cljs.core.next.call(null,seq26988);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26989,seq26988__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26999__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26999__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26999__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26999__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27000 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27000,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27000,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27000,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27000,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27000,(4),null);
var arity = cljs.core.nth.call(null,vec__27000,(5),null);
...
var o__26029__auto__ = f;
return (o__26029__auto__["getBasis"]).call(o__26029__auto__);
});
/**
...
}catch (e27004){var _e__26036__auto__ = e27004;
...
var G__27005 = (obj[cljs.core.first.call(null,path)]);
var G__27006 = cljs.core.rest.call(null,path);
obj = G__27005;
path = G__27006;
continue;
} else {
...
return (function (accum,p__27007){
var vec__27008 = p__27007;
var bit = cljs.core.nth.call(null,vec__27008,(0),null);
var protocol = cljs.core.nth.call(null,vec__27008,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27011){
var vec__27012 = p__27011;
var ns = cljs.core.nth.call(null,vec__27012,(0),null);
var name = cljs.core.nth.call(null,vec__27012,(1),null);
var selector = cljs.core.nth.call(null,vec__27012,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27017,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27017,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27017,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27015_SHARP_){
return (obj[cljs.core.first.call(null,p1__27015_SHARP_)]);
});})(name,sorted_matches,vec__27017,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
