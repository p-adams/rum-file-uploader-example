...
return cljs.core.reduce.call(null,(function (result,p__27093){
...
var vec__27097 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__27097,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__27097,(1),null);
var ab = cljs.core.nth.call(null,vec__27097,(2),null);
...
return (function (){var G__27106 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27106__$1)].join('')));
